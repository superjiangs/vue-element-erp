...
export const asyncRouterMap = [
  ...
  // { path: '*', redirect: '/404', hidden: true }
  {
    ...
    children: [
      { path: 'index', component: _import('basic/index'), name: 'basicsupplier', meta: { title: 'basicsupplier', role: ['admin'] }},
      { path: 'index', component: _import('basic/index'), name: 'basiccustomer', meta: { title: 'basiccustomer', role: ['admin'] }}
      // { path: 'basic-Engineer', component: _import('basic/basicEngineer'), name: 'basicEngineer', meta: { title: 'basicEngineer' }}
    ]
  }
]
