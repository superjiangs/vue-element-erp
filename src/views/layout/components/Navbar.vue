<template>
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="left-menu">ERP进销存系统</div>
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        <div class="avatar-wrapper">
          <img class="user-avatar" src="../../../assets/index_images/head.png">
...
.navbar {
  ...
  box-shadow: 0px 2px 4px 0px rgba(10, 46, 101, 0.7);
  .left-menu{
    color:#fff;
    margin-left:66px;
  }
